...
class ArtisteController extends AbstractController
{
    ...
    public function welcomepage(EntityManagerInterface $entityManager,Request $request, Security $security, ArtisteRepository $artisteRepository): Response
    {
    ...
    public function new(Request $request, ArtisteRepository $artisteRepository, UserRepository $userRepository, UserPasswordHasherInterface $userPasswordHasher): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $options = ['cost' => 12];
            $hashedPassword = password_hash($form->get('password')->getData(), PASSWORD_BCRYPT, $options);
