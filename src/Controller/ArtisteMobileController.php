...
class ArtisteMobileController extends AbstractController
{
    ...
    {
        return $this->render('artiste_mobile/index.html.twig', [
    ...
    #[Route('/affichageArtiste', name: 'mobile_list_artiste')]
    public function display(ArtisteRepository $artisteRepository, NormalizerInterface $normalizer): Response
    {
